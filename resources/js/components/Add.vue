    ...
    <div class="modal-body">
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="first_name" class="form-control" id="first_name" v-model="guest.first_name" placeholder="Firstname">
            </div>
            <div class="form-group col-md-6">
                <label for="last_name">Lastname</label>
                <input type="text" name="last_name" class="form-control" id="last_name" v-model="guest.last_name" placeholder="Lastname">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-4">
                <label for="email">Email</label>
                <input type="email" name="email" class="form-control" id="email" v-model="guest.email" placeholder="Email">
            </div>
            <div class="form-group col-md-4">
                <label for="phone_number">Phone Number</label>
                <input type="tel" name="phone_number" class="form-control" id="phone_number" v-model="guest.phone_number" placeholder="Phone Number">
            </div>
            <div class="form-group col-md-4">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <textarea class="form-control" name="address" id="address" rows="5" v-model="guest.address"></textarea>
            </div>
        </div>
        ...
        methods : {
            addGuest(){
                if(this.validateForm() == true){
                    axios.post(route('guest.store', 'frontend'), this.$data.guest)
                    .then(response => {
                        this.clearForm();
            ...
            validateForm(){
                if (this.guest.first_name && this.guest.last_name && this.guest.email && this.guest.phone_number && this.guest.gender && this.guest.address) {
                    return true;
                }
