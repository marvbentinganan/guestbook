  ...
  <div>
    ...
    <table class="table table-striped table-bordered">
      ...
      <tbody>
        ...
        <tr v-else v-for="(guest, index) in guests" :key="guest.id">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input
                  ...
                  class="form-control"
                  id="phone_number"
                  v-model="guest_data.phone_number"
...
export default {
  ...
  methods: {
    ...
    updateGuest() {
      axios
        .patch(this.update_route, this.$data.guest_data)
        .then(response => {
          this.getGuests();
    ...
    deleteGuest(id) {
      swal
        ...
        .then(result => {
          if (result.value) {
            axios.delete(route("guest.delete", id)).then(response => {
